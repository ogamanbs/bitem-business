...
export default function LoginCard({setForm, setLoad, messages, setMessages}) {
    return (
        <div className="h-auto w-full md:w-1/3 flex flex-col items-center justify-center text-sm gap-5 px-5 py-20 rounded-[20px] shadow-lg bg-white">
            ...
            <LoginForm setForm={setForm} setLoad={setLoad} messages={messages} setMessages={setMessages} />
        </div>
    )
}
